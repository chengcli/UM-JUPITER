...
# dungeon2
DEVICE_ID=0 python -u run_jupiter_dry.py -r jupiter_dry_100.final.restart -c jupiter_dry_100.yaml --output-dir ./260520_dry_100 &> log.260520_dry_100 &
DEVICE_ID=1 python -u run_jupiter_crm.py -r jupiter_crm_100.final.restart -c jupiter_crm_100.yaml --output-dir ./260520_crm_100 &> log.260520_crm_100 &
