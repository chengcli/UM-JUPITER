...
# dungeon3
DEVICE_ID=0 python run_jupiter_crm.py -r jupiter_crm_1000.final.restart -c jupiter_crm_1000.yaml --output-dir ./260520_crm_1000 > log.260520_crm_1000 &
DEVICE_ID=1 python run_jupiter_dry.py -r jupiter_dry_1000.final.restart -c jupiter_dry_1000.yaml --output-dir ./260520_dry_1000 > log.260520_dry_1000 &
